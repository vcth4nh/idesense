...
class McpSettings : PersistentStateComponent<McpSettings.State> {
    ...
    data class State(
        ...
        var disabledTools: MutableSet<String> = mutableSetOf("ide_build_project", "ide_install_plugin", "ide_restart", "ide_file_structure", "ide_find_symbol", "ide_read_file", "ide_reformat_code", "ide_optimize_imports", "ide_convert_java_to_kotlin"),
