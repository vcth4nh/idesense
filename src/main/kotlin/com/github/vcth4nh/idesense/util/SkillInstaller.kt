 ...
 *
 * The skill files are bundled as JAR resources under /skill/idesense/.
...
object SkillInstaller {
    ...
    private const val SKILL_NAME = "idesense"
     ...
     * Creates the directory structure: targetDir/idesense/SKILL.md, etc.
     *
     ...
     * The zip contains: idesense/SKILL.md, idesense/references/tools-reference.md
     *
